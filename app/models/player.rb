class Player < ActiveRecord::Base
  ...
  private
  	def update_player_scores
  	  ...
  	  self.bowl_score = bowl_wickets*15 + bowl_4_wickets*25 + bowl_6_wickets*50
	  ...
	  self.bat_avg = bat_runs_scored / (bat_innings - bat_not_outs) unless self.bat_avg_invalid
  	  self.bowl_avg_invalid = (bowl_wickets == 0)
      self.bowl_avg = bowl_runs / bowl_wickets unless self.bowl_avg_invalid
  	end
end
