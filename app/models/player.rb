class Player < ActiveRecord::Base
  ...
  private
  	def update_player_scores
  	  self.bat_score = bat_runs_scored + bat_fifties*25 + bat_hundreds*50 + bat_not_outs*5 - bat_ducks*10
  	  self.bowl_score = bowl_wickets*15 + bowl_4_wickets*25 + bowl_6_wickets*50 + bowl_maidens*4
  	  self.field_score = (field_catches + field_runouts + field_stumpings)*15 - field_drops*10
